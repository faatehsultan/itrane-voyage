...
const Desti = () => {
  ...
  <div className="container px-5  pb-24 lg:ml-12 mx-auto">
    <div className="text-center  mb-20">
      <h1 className="font-semibold mt-16 sm:text-5xl text-center title-font text-transparent bg-clip-text bg-gradient-to-br from-yellow-500 to-orange-600 mb-4">Nous voyageons vers toutes les destinations !</h1>
