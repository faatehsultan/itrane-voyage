...
const Testimo = () => {
  ...
  <div className="container px-5 mb-24 mx-auto pb-12">
    <h1 className="sm:text-3xl text-2xl font-medium text-center title-font mb-12 text-transparent bg-clip-text bg-gradient-to-br from-yellow-500 to-red-600">Testimonials</h1>
