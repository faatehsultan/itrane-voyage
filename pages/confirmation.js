              ...
              <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-slate-100 shadow-xl  rounded-md  g-gray-800 space-y-6">
                ...
                <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                  <div className="flex justify-between w-full">
                    ...
                    <p className="text-base    -gray-300 leading-4 text-gray-600">{"$" + detailData["Price"]}.00</p>
                  </div>
                  <div className="flex justify-between items-center w-full">
                    ...
                    <p className="text-base    -gray-300 leading-4 text-gray-600">-{"$" + Number(detailData["Price"]) * (15 / 100)}.00 (15%)</p>
                  </div>
                  <div className="flex justify-between items-center w-full">
                    <p className="text-base   leading-4 text-gray-800">Fees</p>
                    <p className="text-base    -gray-300 leading-4 text-gray-600">$5.00</p>
                  </div>
                </div>
                <div className="flex justify-between items-center w-full">
                  <p className="text-base   font-semibold leading-4 text-gray-800">Total</p>
                  <p className="text-base    -gray-300 font-semibold leading-4 text-gray-600">{"$" + (Number(detailData["Price"]) - (Number(detailData["Price"]) * (15 / 100)) + 8)}.00</p>
                </div>
              </div>
